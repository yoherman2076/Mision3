<template>
  <main class="min-h-screen bg-linear-to-br from-ter via-sec to-prim text-white">

    <!-- Header -->
    <header class="container mx-auto px-6 py-10">
      <h1
        class="mx-auto max-w-3xl rounded-full bg-sec py-5 text-center text-5xl font-extrabold shadow-xl backdrop-blur">
        Welcome to la Misión 4
      </h1>
    </header>
    ...
    <section class="container mx-auto">
      <div class="grid grid-cols-1 gap-8 mx-8 lg:grid-cols-3 items-start mt-10">
        ...
        <!-- Pokémon -->
        <div class="rounded-xl bg-slate-800/70 p-8 border border-slate-700 shadow-2xl backdrop-blur transition duration-500 hover:-translate-y-1 hover:shadow-cyan-500/20">
          <RandomButton
